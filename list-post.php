    ...
    <div class="container">
      ...
      <section class="card wow fadeIn" style="background-image: url(https://mdbootstrap.com/img/Photos/Others/gradient1.jpg);">
        ...
        <div class="card-body text-white text-center py-5 px-5 my-5">
          ...
          <h1 class="mb-4">
            <strong>Список поставщиков</strong>
          </h1>
        ...
        <div class="row mb-4 wow fadeIn">
          ...
          <div class="col-lg-4 col-md-12 mb-4">
            ...
            <div class="card">
              ...
              <div class="view overlay">
                <img src=".\img\energ.jpg" class="card-img-top"
                  alt="">
             ...
             <div class="card-body">
                <!--Title-->
                <h4 class="card-title">ООО <<Белэнергомаш>></h4>
                <!--Text-->
                <p class="card-text">Вебсайт: www.energomash.ru </p>
				<p class="card-text">Электронная почта: info@energomash.ru </p>
				<p class="card-text">Телефон: +7 (4722) 35-43-44</p>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <!--Card image-->
              <div class="view overlay">
                <img src=".\img\amira.jpg" class="card-img-top"
                  alt="">
              ...
              <div class="card-body">
                <!--Title-->
                 <h4 class="card-title">АО <<АМИРА>></h4>
                <!--Text-->
                <p class="card-text">Вебсайт: www.amira.ru </p>
				<p class="card-text">Электронная почта: amira@amira.ru </p>
				<p class="card-text">Телефон: +7 (812) 441-25-00</p>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <!--Card image-->
              <div class="view overlay">
                <img src=".\img\tmc.jpg" class="card-img-top" alt="">
              ...
              <div class="card-body">
                <!--Title-->
                 <h4 class="card-title"><<ТМС групп>></h4>
                <!--Text-->
                <p class="card-text">Вебсайт: тмс-групп.рф </p>
				<p class="card-text">Электронная почта: tmcg@tmcg.ru </p>
				<p class="card-text">Телефон: +7 (8553) 300-442</p>
